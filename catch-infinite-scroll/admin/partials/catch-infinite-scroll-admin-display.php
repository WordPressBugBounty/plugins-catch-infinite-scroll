	...
	<div class="catchp-content-wrapper">
		<div class="catchp_widget_settings">
			...
			<div id="dashboard" class="wpcatchtab  nosave active">
				...
				<div id="ctp-switch" class="content-wrapper col-3 catch-infinite-scroll-main">
					<div class="header">
						<h2><?php esc_html_e('Catch Themes & Catch Plugins Tabs', 'catch-infinite-scroll'); ?></h2>
					</div> <!-- .Header -->

					<div class="content">

						<p><?php echo esc_html__('If you want to turn off Catch Themes & Catch Plugins tabs option in Add Themes and Add Plugins page, please uncheck the following option.', 'catch-infinite-scroll'); ?>
						</p>
						<table>
							<tr>
								<td>
									<?php echo esc_html__('Turn On Catch Themes & Catch Plugin tabs', 'catch-infinite-scroll'); ?>
								</td>
								<td>
			...
			<div id="premium-extensions" class="wpcatchtab  save">
				...
				<div class="about-text">
					...
					<p><?php esc_html_e('You are currently using the free version of Catch Infinite Scroll.', 'catch-infinite-scroll'); ?><br />
						<a href="https://catchplugins.com/plugins/" target="_blank"><?php esc_html_e('If you have purchased from catchplugins.com, then follow this link to the installation instructions (particularly step 1).', 'catch-infinite-scroll'); ?></a>
					</p>
				</div>
